...
@section('content')
    <div class="card my-3">
        <div class="card-header d-flex align-items-center justify-content-between p-3">
            ...
            <p class="my-auto fw-bold text-primary d-lg-none">Productos</p>
            <div class="d-flex">
                <form action="{{route('admin.product.filter')}}" method="get" id="filterForm">
        ...
        <div class="card-body bg-light table-responsive">
            <table class="table">
                ...
                <tr>
                    ...
                    <th scope="col" class="border-dark">Precio</th>
                    <th scope="col" class="border-dark">Stock</th>
                    <th scope="col" class="border-dark">Destacado</th>
            ...
            <p id="noItems" class="text-center d-none">No hay producto</p>
        </div>
